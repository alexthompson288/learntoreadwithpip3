...
public class OldVoyageInfo : Singleton<OldVoyageInfo> 
{
#if UNITY_EDITOR
    [SerializeField]
    ...
    {
        ////////D.Log("OldVoyageInfo.OnCompleteGames");
        GameManager.Instance.CompletedAll -= OnCompleteGames;
    ...
    void OnGameCancel()
    {
        ////////D.Log("OldVoyageInfo.OnGameCancel");
        GameManager.Instance.CompletedAll -= OnCompleteGames;
    ...
    void Load()
    {
        DataSaver ds = new DataSaver(System.String.Format("OldVoyageInfo_{0}", UserInfo.Instance.GetCurrentUserName()));
    ...
    void Save(string user = null)
    {
        ...
        DataSaver ds = new DataSaver(System.String.Format("OldVoyageInfo_{0}", user));
