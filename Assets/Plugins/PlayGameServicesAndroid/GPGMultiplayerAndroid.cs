...
public class GPGMultiplayer
{
	...
	static GPGMultiplayer()
	{
		...
		{
			Json.useSimpleJson = true;
			_plugin = pluginClass.CallStatic<AndroidJavaObject>( "realtimeMultiplayerInstance" );

			//var messageReceivedListener = new PlayGameServicesMultiplayer.RealTimeMessageReceivedListener();
			//Debug.Log( "+++ messageReceivedListener: " + messageReceivedListener );
			//new AndroidJavaObject( "com.prime31.RealtimeListenerProxy", messageReceivedListener );
